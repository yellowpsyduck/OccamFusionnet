...
from occam.utils import str2bool
from occam.general_utils import normalize_text, build_embedding, load_glove_vocab, feature_gen, token2id, process_jsonlines
...
if args.pre_proc == 'sru':
    from occam.general_utils import pre_proc_sru as pre_proc
elif args.pre_proc == 'fusion':
    from occam.general_utils import pre_proc_fusion as pre_proc
elif args.pre_proc == 'qanet':
    from occam.general_utils import pre_proc_qanet as pre_proc
else:
